...
export default function AuthGuard({ children }) {
  ...
  useEffect(() => {
    axios.get('/oauth/jira/status').then(r => setStatus(r.data)).catch(() => setStatus({ connected: false }))
  }, [])
  ...
  if (!status.connected) return (
    <div className="empty-state">
      ...
      <a href="http://localhost:3001/oauth/jira/login" target="_blank" rel="noreferrer">
